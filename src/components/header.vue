        ...
        <nav class="text-2xl space-x-10 text-white flex mr-6">
            ...
            <section class="relative group">
                <section class="flex items-center gap-3">
                    <img src="../assets/profile-icon-person-user-19.png"
                        class="w-10 cursor-pointer bg-white p-1 rounded-full" alt="">
                    <h2 class="font-serif text-3xl cursor-pointer">{{ store.username }}</h2>
                </section>
                <div class="absolute hidden group-hover:block w-32 h-28 bg-slate-600 top-12 right-0 rounded-lg">
                    <section class="flex flex-col">
                        <button class="flex justify-center text-xl mt-5 hover:scale-105 gap-2"><svg width="25px"
                                height="25px" viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path
                        ...
                        <RouterLink to="/" class="flex justify-center items-center text-xl mt-5 hover:scale-105 gap-2"><svg
