...
<template>
    <div :class="`main-layout ${isOpen ? 'active' : ''}`">
        ...
        <div>
            <header
                style="height: 70px;background-color: #003a62;display: flex;align-items: center;justify-content: space-between;padding-inline: 10px;">
                ...
                <div class="profile">
                    <svg fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        xml:space="preserve" stroke="#ffffff" stroke-width="0.00045531999999999994">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <g>
